...
# Structured logging
logger = setup_logger("01_House_Price_Prediction")

app = FastAPI(
    title="House Price Prediction API",
    description="Microservice for Luxury Real Estate prediction models.",
    version="1.0.0"
)
...
def predict(data: PredictionInput):
    ...
    try:
        ...
        db.log_prediction("01_House_Price_Prediction", data.dict(), result_payload, latency)
...
def get_prediction_history(limit: int = 100):
    try:
        return db.get_history("01_House_Price_Prediction", limit=limit)
    except Exception as e:
...
def clear_prediction_history():
    try:
        db.clear_history("01_House_Price_Prediction")

...
**House Price Prediction** predicts **Price** using a trained **GradientBoostingRegressor** model.
...
```bash
git clone https://github.com/Suryaflame5/House_Price_Prediction.git
...
curl -X POST http://localhost:8000/predict \
  ...
  -d '{"SquareFootage": 2500, "Bedrooms": 3, "Bathrooms": 2.5, "YearBuilt": 2000, "NeighborhoodQuality": 7, "DistanceToCenter": 10.0}'
```

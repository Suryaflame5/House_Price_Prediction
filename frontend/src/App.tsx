...
export default function App() {
  ...
  const [formData, setFormData] = useState<any>({ SquareFootage: 2500, Bedrooms: 3, Bathrooms: 2.5, YearBuilt: 2000, NeighborhoodQuality: 7, DistanceToCenter: 10.0 });
    ...
    <div className="min-h-screen flex flex-col relative text-white bg-slate-950">
      ...
      <header className="glass-panel sticky top-0 z-30 px-6 py-4 flex flex-col md:flex-row justify-between items-center border-b border-white/5 backdrop-blur-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight text-white">House Price Prediction</h1>
            <p className="text-xs text-slate-400 font-medium">Luxury Real Estate Intelligence Portal</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="mb-4">
              <div className="flex justify-between mb-1">
                <label className="text-sm font-medium text-slate-300">Square Footage (sqft)</label>
                <span className="text-xs font-semibold text-primary bg-primary/20 px-2 py-0.5 rounded">{formData.SquareFootage}</span>
              </div>
              <input
                type="range"
                min="500"
            ...
            <div className="mb-4">
              <div className="flex justify-between mb-1">
                ...
                <span className="text-xs font-semibold text-primary bg-primary/20 px-2 py-0.5 rounded">{formData.Bedrooms}</span>
              </div>
              <input
                type="range"
                min="1"
            ...
            <div className="mb-4">
              <div className="flex justify-between mb-1">
                <label className="text-sm font-medium text-slate-300">Number of Bathrooms</label>
                <span className="text-xs font-semibold text-primary bg-primary/20 px-2 py-0.5 rounded">{formData.Bathrooms}</span>
              </div>
              <input
                type="range"
                min="1"
            ...
            <div className="mb-4">
              <div className="flex justify-between mb-1">
                <label className="text-sm font-medium text-slate-300">Year Built</label>
                <span className="text-xs font-semibold text-primary bg-primary/20 px-2 py-0.5 rounded">{formData.YearBuilt}</span>
              </div>
              <input
                type="range"
                min="1900"
            ...
            <div className="mb-4">
              <div className="flex justify-between mb-1">
                <label className="text-sm font-medium text-slate-300">Neighborhood Quality Rating</label>
                <span className="text-xs font-semibold text-primary bg-primary/20 px-2 py-0.5 rounded">{formData.NeighborhoodQuality}</span>
              </div>
              <input
                type="range"
                min="1"
                ...
                onChange={(e) => setFormData({ ...formData, NeighborhoodQuality: Number(e.target.value) })}
              />
              <div className="flex justify-between text-[10px] text-slate-500 mt-1">
                <span>1</span>
                <span>10</span>
            ...
            <div className="mb-4">
              <div className="flex justify-between mb-1">
                <label className="text-sm font-medium text-slate-300">Distance to City Center (km)</label>
                <span className="text-xs font-semibold text-primary bg-primary/20 px-2 py-0.5 rounded">{formData.DistanceToCenter}</span>
              </div>
              <input
                type="range"
                min="0.5"
                ...
                onChange={(e) => setFormData({ ...formData, DistanceToCenter: Number(e.target.value) })}
              />
              <div className="flex justify-between text-[10px] text-slate-500 mt-1">
                <span>0.5</span>
                <span>50.0</span>
            ...
            <div className="space-y-6">
              <div className="p-4 rounded-xl bg-slate-900/40 border border-white/5">
                ...
                <div className="text-xs space-y-1.5 text-slate-300">
                  <p><strong>Predictors Target Name Label:</strong> Price (regression)</p>
                </div>
              </div>
      ...
      <footer className="py-6 border-t border-white/5 text-center text-[10px] text-slate-500 relative z-10 glass-panel mt-auto">
        <p>© 2026 Antigravity MLOps Suite. Custom theme built for Luxury Real Estate projects.</p>
      </footer>
    </div>
  );
}
